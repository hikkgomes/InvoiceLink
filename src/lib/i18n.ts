...
const MESSAGES: Record<Locale, I18nMessages> = {
  en: {
    ...
    form: {
      ...
      currencyGroups: {
        majorFiat: 'Popular fiat',
        bitcoin: 'Bitcoin',
        otherFiat: 'Other fiat',
      },
  ...
  fr: {
    ...
    form: {
      ...
      currencyGroups: {
        majorFiat: 'Fiat populaire',
        bitcoin: 'Bitcoin',
        otherFiat: 'Autre fiat',
      },
  ...
  de: {
    ...
    form: {
      ...
      currencyGroups: {
        majorFiat: 'Beliebte Fiat',
        bitcoin: 'Bitcoin',
        otherFiat: 'Andere Fiat',
      },
  ...
  it: {
    ...
    form: {
      ...
      currencyGroups: {
        majorFiat: 'Fiat popolare',
        bitcoin: 'Bitcoin',
        otherFiat: 'Altro fiat',
      },
